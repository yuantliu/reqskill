...
module.exports = function (app) {
    ...
    app.route('/api/search/:_city/:_days')
        .get(function (req, res) {
            ...
            //race condition
            if (lock[city] == undefined || lock[city] == null) {
                lock[city] = true;
                ...
                console.log("Currently being used for " + city);
                //currently searching for city. return wait message
                res.end(JSON.stringify({ "error": city + " is currently updating. Please check back later." }));
            }
        });
};